...
The implementation of our analysis does not currently support all of Clight.
Function pointers, goto statements, and stack-allocated
variables that have their address taken are not supported by the
automatic analysis.  While these limitations concern the current
implementation, our technique is in principle capable to handle them.
...
Even some linear programs cannot be analyzed automatically by
