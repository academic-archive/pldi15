...
\end{array}
$$
\flushleft Linear Objective Function:
$$
q_{x,0} + 10000{\cdot}q_{0,x} + 10{\cdot}q_{x,10} + 9990q_{10,x}
$$
\flushleft Constant Objective Function:
$$
q_0 + 11{\cdot}q_{0,10}  
$$
...
lead to the optimal solution.  In this case, the objective value would
be
$$
5000
$$
...
a particularly simple form that is know as \emph{network problem}.
Such problems can be solve in linear time in practice.
