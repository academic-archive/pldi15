...
number $\#_1(a)$.  For example, on line 5 of the example
...
\lstinline{na > 0} at line 4 does not influence the loop behavior.  It
is done by proving inductively that $na = \#_1(a)$
and remarking that since \lstinline{a[x] == 1} is true, we must have
$\#_1(a) > 0$, thus \lstinline{na > 0} is true in the test. %  So the
