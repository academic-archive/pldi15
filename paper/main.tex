...
\begin{figure*}
 \setlength{\progwidth}{.30\linewidth}
  \centering
\hspace{-0.4cm}
...
\\[.4\baselineskip]
  ...
  \end{minipage}
\vspace{1ex}
\caption{Exampel \emph{t39} shows two mutually-recursive functions
  with the computed tick bounds.  The derived constant factors are
  tight.}
  \label{fig:ex_list_2}
\end{figure*}
...
\paraskip
\paragraph{Examples: Challenging Loops.}
...
count up $y$ by $2$ and recursively call \code{count\_down}.  $\toolname$ is 
