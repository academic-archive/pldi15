...
\paragraph{Semantic meaning of triples.}
...
We can now define the \emph{semantic validity} of a function-context
free logic judgement $B; R \vdash \htriple P S Q$ as follows
\begin{align*}
\valid n B R P S Q := \\
\forall m\, \cont .\,& (m \le n \land \safeK m B R Q \cont) \\
&\implies \safe m P S \cont.
\end{align*}
We use this validity definition to give a meaning to function
specifications $\forall z \, \vec v \, v.(P_f \, z \, \vec v,
Q_f \, z \, v)$ as follows
$$
  \forall z \, \vec v \, n .\,
