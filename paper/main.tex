...
\begin{abstract}
  ...
  Coq Proof Assistant.  The logic is very expressive and a shallow
  ...
  integers and differences between numbers, which is crucial to handle
  ...
  derived constant factors in our bounds are often more precise.
\end{abstract}
...
properties can often be more tedious then reasoning about intentional
...
restrict our self to linear bounds in the automatic analysis (there
