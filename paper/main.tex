...
with automatically inferred bounds.  One reason for this
impossibility to interact is that available tools work
on a highly abstract version of the source program. This
abstracted program has a lot more behaviors than the
original one and is usually expressed in a language that
is not able to express memory operations.
...
the benefits of amortized reasoning.  It handles, using
