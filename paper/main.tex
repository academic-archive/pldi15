...
$M_f$ for function calls and $M_r$ for \code{return} statements.  \iffull{This
...
global and local variables using logical variables\iffull{ (see the
...
assertion since we do not infer any logical assertion on the contents
