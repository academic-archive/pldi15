...
$\state'$.  However, the assertion $B : \Assn$ provides the
...
Finally, the function context 
$$\Delta {:} \text{Funs} \to \Z^*
\\
((\Val \times \Mem) {\to} \N \cup \{\infty\}) {\times} ((\Val \times \Mem) {\to} \N {\cup} \{\infty\})$$ 
...
\Rule{L:Call}
{
  \Delta f = \forall z\,\vec v.(P_f\,z\,\vec v, Q_f\,z) \\
