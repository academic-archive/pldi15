...
%
\and\Rule{Q:Call}
{ (\vec y, s, \Gamma_f, Q_f, Q_f', \Gamma_f') \in \Delta(f)
...
\\ R = Q_f[\vec y / \vec x]
\\ R' = Q'_f[s/r]
\\ \forall i \in \dom{R} . \, p_i = r_i
\\ \forall i \in \dom{R'} .\, p'_i = r'_i 
\\ \forall i \not\in \dom{R'} .\, p'_i = 0
\\ \forall i \not\in \text{Loc}
  .\, s_i = 0
}
{ \Gamma_f[\vec y / \vec x] \land \Gamma_{\text{Loc}}; B; R; Q + c
  \vdash r \gets f(\vec x) \dashv
  Q' + c; \Gamma_f'[s/r] \land \Gamma_{\text{Loc}}
}
%
\and \Rule{Q:Weak}
