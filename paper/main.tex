...
In the second category, are based on type systems for functional
programs and the potential method of amortized
...
\jan{We also mention before that existing imperative tools don't allow
  ...
  \item just add another bullet to say that we have the same
    ...
    manual and automatic bounds and be composed
  \end{itemize}
}
