...
logical assertions from potential functions by semicolons. Note that the
...
We present the rules for a subset of the
...
that is defined in the rule {\sc Relax} that
...
Our current implementation of $\toolname$ does not currently support
