...
\item Existing tools work on a highly abstracted
  ...
  bound.
\itemskipIn
\item Maybe we can mention resource freeing                    XXX
\end{itemize}
...
strict time and memory constraints.  To ensure that these
...
C programs.  We generalize this work by allowing to
reason on any resource.  The automation, which is the
...
resource bounds in the previous logic on a large class
of programs.
