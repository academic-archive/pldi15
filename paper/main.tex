...
integers. It also handles programs with mutually recursive functions as
well as \code{break} and \code{return} statements.  Using the
potential-based approach of amortized analysis allows us to
use a single mechanism to analyze programs that need special treatment in other
techniques.  For instance, we can naturally handle
\itemskip
\begin{itemize}
