...
\lstset{moredelim=[is][\underbar]{_}{_},keepspaces=true}
...
a binary counter \code{k} times.  A naive analysis of
...
and the original one, we use the inequality $\code{lg} >
\log_2(\code h-\code l)$ as invariant.  This trick allows a simpler
