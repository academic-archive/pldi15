...
\nocaptionrule \caption{
  ...
  $\max(a,b)$ for the maximum of $a$ and $b$.  Functions with names of the form \code{tXX} are challenging tests
  that we designed during the development of $\toolname$.  The source code for all functions
